...
public class FlightService {
	...
	/**
	 * return a new list with all flights where aircraft, origin, destination or airline contains
	 * search string
	 * 
	 * @param searchString
	 * @return
	...
	public List<FlightModel> getFilteredFlights(String searchString) {
		...
		for (FlightModel FlightModel : flights) {
			...
			if (
				(FlightModel.getAircraft() != null && FlightModel.getAircraft().contains(searchString)) ||
